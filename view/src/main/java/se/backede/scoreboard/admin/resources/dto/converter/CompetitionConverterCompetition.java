 ...
 */
@FacesConverter("competitionConverterCompetition")
public class CompetitionConverterCompetition implements Converter {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String teamId) {
        ...
        return competitionController.getCompetitionById(teamId);
    }
