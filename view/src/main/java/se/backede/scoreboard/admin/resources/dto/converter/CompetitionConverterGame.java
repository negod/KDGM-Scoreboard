 ...
 */
@FacesConverter("competitionConverterGame")
public class CompetitionConverterGame implements Converter {

    @Override
    public Object getAsObject(FacesContext fc, UIComponent uic, String gameId) {
        ValueExpression vex
        ...
        return competitionController.getTeamById(gameId);
    }
